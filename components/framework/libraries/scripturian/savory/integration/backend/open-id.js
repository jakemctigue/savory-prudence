 ...
 * @version 1.0
 */
Savory.OpenID = Savory.OpenID || function() {
	/** @exports Public as Savory.OpenID */
    var Public = {}
	 ...
	 * 
	 * @class
	 * @name Savory.OpenID.Provider
	 * @param {String} name Used by us to differentiate among several supported providers
	 * @param {String} xrdsUri The provider's XRDS URI (see {@link Savory.OpenID#discoverXrdsUri})
	...
	Public.Provider = Sincerity.Classes.define(function(Module) {
		 ...
		 * @see Savory.OpenID.Endpoint#getAuthenticationUri
		 */

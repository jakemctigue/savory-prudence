 ...
 * @version 1.0
 */
Savory.OAuth = Savory.OAuth || function() {
	/** @exports Public as Savory.OAuth */
    var Public = {}
	...
	Public.Provider = Sincerity.Classes.define(function(Module) {
		...
		function getAttributes(now) {
			...
			return {
				...
				oauth_nonce: Savory.Nonces.create(0),
	...
	var defaultDuration = application.globals.get('savory.integration.backend.oauth.defaultDuration') || (15 * 60 * 1000)
	var oauthSecrets = new Savory.Cache({name: 'secret', collection: 'oauth_secrets', defaultDuration: defaultDuration, logger: Public.logger})

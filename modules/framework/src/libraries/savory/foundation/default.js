...
document.executeOnce('/savory/foundation/calendar/')
...
document.executeOnce('/savory/foundation/html/forms/')
document.executeOnce('/savory/foundation/html/markup/')
document.executeOnce('/savory/foundation/html/parsing/')
document.executeOnce('/savory/foundation/html/validation/')

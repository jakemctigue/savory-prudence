...
function getNode(fullName, create) {
	...
	JSDOC.opt.D.extscript = JSDOC.opt.D.extscript || 'script/ext/ext-all.js'
	JSDOC.opt.D.extstyle = JSDOC.opt.D.extstyle || 'style/ext/style/css/ext-all.css'
...
function publish(symbolSet) {
	...
	var scriptDir = outputDir + SYS.slash + 'script'
	...
	IO.saveFile(scriptDir, 'documentation.js', documentationTemplate.process())
